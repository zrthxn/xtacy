...
exports.generalRegister = (data, hash) => {
    ...
    return new Promise((resolve,reject)=>{
        ...
        genReq.open('POST', 'http://xtacy.org/_register/gen/', true);
...
exports.competeRegister = (data, hash) => {
    ...
    return new Promise((resolve,reject)=>{
        ...
        comReq.open('POST', 'http://xtacy.org/_register/com/', true);
...
exports.ticketRegister = (data, hash) => {
    ...
    return new Promise((resolve,reject)=>{
        ...
        ticReq.open('POST', 'http://xtacy.org/_register/tic/', true);
...
exports.getEventData = (eventId) => {
    return new Promise((resolve,reject)=>{
        ...
        eventReq.open('GET', 'http://xtacy.org/register/_eventData/' + eventId + '/', true);
        eventReq.send();
